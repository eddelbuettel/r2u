...
## Third: ensure R 4.2.0 is used (could use CRAN too)
echo "deb [arch=amd64] http://ppa.launchpad.net/edd/misc/ubuntu jammy main" > /etc/apt/sources.list.d/edd-misc.list
