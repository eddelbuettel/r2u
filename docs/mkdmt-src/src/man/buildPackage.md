...
buildUpdatedPackages(tgt, debug = FALSE, verbose = FALSE, force = FALSE,
  xvfb = FALSE, bioc = FALSE, dryrun = FALSE)
```
...
| `tgt`      | character Name (or version) of the build target distribution, this is restricted to either “20.04”, “22.04” or “24.04” (or their names “focal”, “jammy” or “noble”\_ |
...
| `compile`  | logical Optional value to ensure compilation from source, default is ‘FALSE’                                                                                         |
...
| `bioc`     | logical Optional switch for BioConductor build                                                                                                                       |
...
build-dependency count. The `buildUpdatedPackages` function finds a set
