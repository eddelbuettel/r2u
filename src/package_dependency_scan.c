// Borrowed with love and admiration from base R. This file was mostly
// written by Kurt Hornik with contributions from Brian D, Ripley.
...
#include <ctype.h>
//#include "tools.h"
// One-liner needed from tools.h, used with i18n here
